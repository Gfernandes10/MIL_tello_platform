...
angular = Simulink.Bus;
angular.HeaderFile = '';
angular.Description = '';
angular.DataScope = 'Auto';
angular.Alignment = -1;
angular.Elements = elems;
clear elems;
assignin('base','angular', angular);
...
linear.HeaderFile = '';
linear.Description = '';
linear.DataScope = 'Auto';
linear.Alignment = -1;
linear.Elements = elems;
clear elems;
assignin('base','linear', linear);
...
Twist.HeaderFile = '';
Twist.Description = '';
Twist.DataScope = 'Auto';
Twist.Alignment = -1;
Twist.Elements = elems;
clear elems;
assignin('base','Twist', Twist);
...
elems(6).Name = 'velocity_command';
elems(6).Dimensions = 1;
elems(6).DimensionsMode = 'Fixed';
elems(6).DataType = 'Bus: Twist';
